...
export const bleedingHistoryDomains: HistoryDomain[] = [
  ...
  {
    id: "infection",
    label: "ถามการติดเชื้อ อาการป่วย หรือวัคซีนก่อนหน้า",
    points: 4,
    keywords: ["ไข้", "หวัด", "ไอ", "เจ็บคอ", "ท้องเสีย", "ติดเชื้อ", "ป่วยก่อน", "หลังเป็นหวัด", "วัคซีน", "ฉีดวัคซีน", "mmr", "live vaccine", "เชื้อเป็น"],
    missed: "ควรถามไข้ หวัด การติดเชื้อ และวัคซีนที่ได้รับก่อนเริ่มมีเลือดออก",
  },
  {
    id: "medication",
